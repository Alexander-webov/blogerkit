...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL || "https://blogerkit.ru",
  ),
  title: {
  ...
  description:
    "Бесплатные инструменты для блогеров: конструктор обложек YouTube, анализ конкурентов, калькулятор стоимости рекламы, советы по продвижению в 2026 году.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Бесплатные инструменты для блогеров: обложки, анализ конкурентов, калькулятор рекламы, советы по продвижению.",
    images: [
      { url: "/og/main.png", width: 1200, height: 630, alt: "БлогерКит" },
    ],
  },
  twitter: {
    ...
    <html lang="ru">
      ...
      <body className={`${inter.className} bg-bg text-white min-h-screen`}>
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/107242407"
