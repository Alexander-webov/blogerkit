...
export const metadata: Metadata = {
  title: 'БлогерКит — бесплатные инструменты для блогеров 2025',
  description: 'Конструктор обложек YouTube, анализ конкурентов, калькулятор стоимости рекламы и советы по продвижению. Всё бесплатно для блогеров.',
...
const tools = [
  {
    ...
    features: ['Реальные данные YouTube API', '10 ниш: авто, финансы, игры...', 'Анализ заголовков и паттернов'],
    href: '/trends',
    badge: 'Бесплатно',
  ...
  },
  {
    ...
    features: ['Реальные данные YouTube', 'Паттерны топ-видео', 'Советы по нише'],
    href: '/analyze',
    badge: '29 ₽',
  ...
  },
  {
    ...
    features: ['8 вариантов за секунду', 'Оценка CTR каждого', '5 стилей: вирусный, SEO, список...'],
    href: '/titles',
    badge: 'Pro',
  ...
  },
  {
    ...
    features: ['Просмотры, вовлечённость, рост', 'Лучшее и худшее видео', 'AI-советы по улучшению'],
  ...
  },
  {
    ...
    features: ['Данные, цены, контакты', 'Темный дизайн с брендингом', 'Скачивание в 1 клик'],
    href: '/mediakit',
    badge: 'Pro',
  ...
  },
  {
    ...
    features: ['YouTube, TikTok, Telegram, VK', 'Учитывает нишу и охват', 'Диапазон min–max'],
    href: '/calculator',
    badge: 'Бесплатно',
    badgeColor: 'text-green-400 bg-green-400/10 border-green-400/20',
  ...
  },
  {
    ...
    features: ['16:9 → 9:16, 1:1, 4:5', 'Прямо в браузере', 'Без установки программ'],
    href: '/crop',
    badge: 'Бесплатно',
    badgeColor: 'text-green-400 bg-green-400/10 border-green-400/20',
    gradient: 'from-purple-500 to-pink-500',
    ...
    <main>
      ...
      <nav className="sticky top-0 z-50 h-14 flex items-center justify-between px-6 bg-bg/95 backdrop-blur border-b border-border">
        ...
        <div className="flex items-center gap-3">
          <Link href="/trends"  className="text-xs text-muted hover:text-white transition-colors">Тренды</Link>
          <Link href="/analyze" className="text-xs text-muted hover:text-white transition-colors">Анализ</Link>
          <Link href="/covers"  className="text-xs text-muted hover:text-white transition-colors">Обложки</Link>
          <Link href="/blog"    className="text-xs text-muted hover:text-white transition-colors">Блог</Link>
          <Link href="/analyze" className="px-3 py-1.5 bg-accent text-white text-xs font-bold rounded-lg hover:opacity-85 transition-opacity">
            Начать →
          </Link>
        </div>
      </nav>
      ...
      <section className="relative overflow-hidden pt-20 pb-16 px-6 text-center">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-black tracking-tight leading-tight mb-4">
            Все инструменты блогера<br />
            <span className="bg-gradient-to-r from-accent to-accent2 bg-clip-text text-transparent">
              в одном месте
            </span>
          </h1>
          <p className="text-muted text-sm leading-relaxed max-w-lg mx-auto mb-8">
            Конструктор обложек, анализ конкурентов, калькулятор рекламы и советы по продвижению.
            Бесплатно для YouTube, TikTok, ВКонтакте и Telegram.
          </p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/analyze" className="px-6 py-3 bg-accent text-white font-bold text-sm rounded-xl hover:opacity-85 transition-all hover:-translate-y-0.5">
              Анализировать конкурентов →
            </Link>
            <Link href="/covers" className="px-6 py-3 border border-border text-sm rounded-xl hover:border-white/20 transition-colors">
              Создать обложку
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20" id="tools">
        <h2 className="font-heading text-xl font-bold text-center mb-2">Инструменты</h2>
        <p className="text-muted text-sm text-center mb-10">9 инструментов · бесплатно и Pro · без регистрации</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {tools.map((tool) => (
            ...
            >
              <div className={`w-full h-0.5 rounded-full bg-gradient-to-r ${tool.gradient} mb-4 opacity-70 group-hover:opacity-100 transition-opacity`} />
              <div className="text-3xl mb-3">{tool.icon}</div>
              <div className="flex items-center gap-2 mb-2">
                <h3 className="font-bold text-sm">{tool.name}</h3>
                <span className={`text-xs px-2 py-0.5 rounded border font-bold ${tool.badgeColor}`}>
                  {tool.badge}
                </span>
              </div>
              <p className="text-muted text-xs leading-relaxed mb-3">{tool.desc}</p>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: '🎬', title: 'YouTube блогеры', desc: 'Анализируй конкурентов, создавай кликабельные обложки и публикуй в лучшее время' },
            { icon: '🎵', title: 'TikTok авторы', desc: 'Советы по алгоритму, кроп видео в формат 9:16 и анализ трендовых ниш' },
            { icon: '✈️', title: 'Telegram каналы', desc: 'Рассчитай стоимость рекламы и узнай как правильно расти в Telegram в 2025' },
          ].map((item) => (
      ...
      <section className="max-w-2xl mx-auto px-6 pb-24">
        <h2 className="font-heading text-xl font-bold text-center mb-8">Частые вопросы</h2>
      ...
      <footer className="border-t border-border px-6 py-8 text-center">
        ...
        <p className="text-muted text-xs mb-4">Инструменты для блогеров · Бесплатно · 2025</p>
        <div className="flex justify-center gap-6 text-xs text-muted">
          <Link href="/covers"     className="hover:text-white transition-colors">Обложки</Link>
          <Link href="/analyze"    className="hover:text-white transition-colors">Анализ</Link>
          <Link href="/calculator" className="hover:text-white transition-colors">Калькулятор</Link>
          <Link href="/tips"       className="hover:text-white transition-colors">Советы</Link>
          <Link href="/crop"       className="hover:text-white transition-colors">Кроп</Link>
        </div>
      </footer>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          description: 'Бесплатные инструменты для блогеров YouTube, TikTok, Telegram',
          potentialAction: {
            '@type': 'SearchAction',
