...
export const metadata: Metadata = {
  ...
  description: 'Смотри какие видео набирают просмотры на YouTube прямо сейчас. Тренды по нишам: авто, финансы, игры, еда, фитнес. Реальные данные каждые 2 часа.',
  keywords: ['тренды youtube 2025', 'популярные видео youtube сейчас', 'что снимать youtube', 'тренды youtube россия'],
  ...
  return (
    <>
      <div className="sr-only">
        <h1>Тренды YouTube 2025 — популярные видео по нишам прямо сейчас</h1>
      </div>
      <TrendsTool />
