    ...
    <div className="flex flex-col" style={{ height: "100dvh" }}>
      ...
      <nav className="h-14 flex items-center justify-between px-6 bg-bg/95 backdrop-blur border-b border-border flex-shrink-0 z-40">
        ...
        <div className="flex items-center gap-3">
          <span className="text-muted text-lg">🎨 Конструктор обложек</span>
          <span className="text-lg px-2 py-0.5 border border-green-400/25 bg-green-400/10 text-green-400 rounded font-bold">
            Бесплатно
          </span>
        </div>
      </nav>
