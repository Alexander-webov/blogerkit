  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="bg-surface border border-border rounded-3xl p-8 max-w-sm w-full text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-400/10 border border-yellow-400/20 text-yellow-400 text-lg mb-6">
        ...
        <div className="font-heading text-4xl font-black text-yellow-400 mb-6">
          {p.price} ₽
        </div>
        <button
          onClick={simulatePay}
        ...
        <p className="text-muted text-lg mt-3">
          Добавь{" "}
          <code className="bg-white/10 px-1 rounded">PRODAMUS_SHOP_URL</code> в
          .env.local для реальных платежей
        </p>
      </div>
    </div>
  );
