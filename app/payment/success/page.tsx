...
export default function PaymentSuccess() {
  ...
  const MSGS: Record<string, { title: string; desc: string; link: string; btn: string }> = {
    'channel-analysis': { title: 'Анализ канала разблокирован!', desc: 'Введи ссылку на любой YouTube канал — получи полную статистику.', link: '/channel-analysis', btn: 'Анализировать канал →' },
    'mediakit':         { title: 'Медиакит доступен!',            desc: 'Заполни данные и скачай PDF прямо сейчас.',                       link: '/mediakit',          btn: 'Создать медиакит →' },
    'pro-video':        { title: 'Видеоредактор Pro активирован!', desc: 'Нарезка, субтитры и фильтры теперь доступны.',                    link: '/crop',              btn: 'Открыть редактор →' },
    'pro-monthly':      { title: 'БлогерКит Pro активирован!',    desc: 'Все инструменты Pro теперь доступны без ограничений.',            link: '/',                  btn: 'К инструментам →' },
  }
