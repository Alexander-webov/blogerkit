...
export const metadata: Metadata = {
  ...
  description: 'Полезные статьи для блогеров: алгоритм YouTube, обложки, монетизация, продвижение. 23 актуальных гайда 2025.',
    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-muted text-sm">23 статьи про YouTube, TikTok и Telegram · Актуально в 2025</p>
        </div>
