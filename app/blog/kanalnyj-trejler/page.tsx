...
export const metadata: Metadata = {
  ...
  description:
    "Как снять трейлер YouTube канала: структура, длина, что говорить. Шаблон сценария который увеличивает конверсию в подписку.",
  keywords: ["трейлер youtube канала", "youtube блогер 2026", "контент"],
  alternates: { canonical: "https://blogerkit.ru/blog/kanalnyj-trejler" },
  openGraph: {
    title:
      "Как сделать трейлер YouTube канала который конвертирует подписчиков",
    description:
      "Как снять трейлер YouTube канала: структура, длина, что говорить. Шаблон сценария который увеличивает конверсию в подписку.",
    ...
    <div className="min-h-screen bg-bg">
      ...
      <article className="max-w-2xl mx-auto px-6 py-12">
        <div className="flex items-center gap-2 text-muted text-lg mb-4">
          ...
          <span>·</span>
          <time dateTime="2026-04-10">10 апреля 2026 г.</time>
        </div>
        ...
        <p className="text-muted leading-relaxed mb-8">
          Трейлер канала — это автоматический продавец. Каждый новый зритель
          видит его первым. Сделай его правильно.
        </p>

        <div className="p-4 bg-accent/8 border border-accent/20 rounded-xl mb-8 flex items-center justify-between gap-4">
          <div>
            <div className="font-bold text-sm mb-0.5">
              Создай профессиональную обложку для канала
            </div>
        ...
        <div className="text-sm leading-relaxed space-y-6">
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Длина трейлера: 45-90 секунд
            </h2>
            <p className="text-muted">
              Меньше — не успеешь убедить. Больше — потеряешь внимание. 60
              секунд — золотой стандарт. YouTube показывает трейлер только
              незнакомым зрителям, не подписчикам.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
            ...
            <p className="text-muted">
              Секунды 0-5: кто ты и о чём канал. Секунды 5-30: лучшие моменты
              канала (нарезка). Секунды 30-50: что зритель получит подписавшись.
              Секунды 50-60: прямой призыв подписаться.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Говори о зрителе, не о себе
            </h2>
            <p className="text-muted">
              Ошибка большинства: "Меня зовут Иван, я снимаю видео о финансах".
              Правильно: "Если ты хочешь выйти на пассивный доход — ты попал на
              нужный канал". Фокус на боли и желаниях зрителя.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
            ...
            <p className="text-muted">
              Нарежь 5-10 самых ярких моментов с канала. Быстрый монтаж,
              динамика, эмоции. Это социальное доказательство — зритель видит
              что у тебя уже есть крутой контент.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Обнови трейлер раз в полгода
            </h2>
            <p className="text-muted">
              Канал развивается — качество растёт. Старый трейлер может
              отпугивать новых зрителей если он снят 2 года назад. Обновляй
              каждые 6-12 месяцев.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col gap-2">
            <Link
              href="/blog/kak-uvelichit-podpischikov"
              className="flex items-center gap-2 text-sm text-muted hover:text-white transition-colors"
            >
              <span>📈 Как увеличить подписчиков</span>
