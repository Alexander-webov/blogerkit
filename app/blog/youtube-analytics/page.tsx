...
export const metadata: Metadata = {
  ...
  description:
    "Разбор YouTube Analytics: какие метрики важны, что означает каждый показатель и как использовать данные для роста канала.",
  keywords: [
    "youtube analytics как читать",
    "youtube блогер 2026",
    "аналитика",
  ],
    ...
    <div className="min-h-screen bg-bg">
      ...
      <article className="max-w-2xl mx-auto px-6 py-12">
        <div className="flex items-center gap-2 text-muted text-lg mb-4">
          ...
          <span>·</span>
          <time dateTime="2026-05-01">1 мая 2026 г.</time>
        </div>

        <h1 className="font-heading text-3xl font-black leading-tight mb-4">
          YouTube Analytics — как читать статистику и принимать решения
        </h1>
        <p className="text-muted leading-relaxed mb-8">
          YouTube Studio показывает десятки метрик. Большинство из них — шум.
          Вот 6 которые реально важны.
        </p>

        <div className="p-4 bg-accent/8 border border-accent/20 rounded-xl mb-8 flex items-center justify-between gap-4">
          <div>
            <div className="font-bold text-sm mb-0.5">
              Сравни свои показатели с конкурентами
            </div>
        ...
        <div className="text-sm leading-relaxed space-y-6">
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              CTR — первая метрика которую смотреть
            </h2>
            <p className="text-muted">
              Impression Click-Through Rate. Норма: 4-8%. Ниже 4% — проблема с
              обложкой или заголовком. Выше 8% — отличный результат, масштабируй
              формат. Смотри CTR по каждому видео, не только общий.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              AVD — средняя длительность просмотра
            </h2>
            <p className="text-muted">
              Average View Duration. Показывает насколько зрители смотрят твои
              видео. Сравнивай не в процентах а в минутах — длинные видео с 40%
              удержанием лучше коротких с 70%. YouTube продвигает видео с
              большим абсолютным временем просмотра.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
            ...
            <p className="text-muted">
              График удержания показывает где именно зрители уходят. Резкое
              падение в начале = плохой крючок. Плавное снижение = нормально.
              Пики = зрители перематывают к интересным моментам. Исправляй
          ...
          <div>
            ...
            <p className="text-muted">
              Откуда приходят зрители: поиск YouTube, главная страница, похожие
              видео, внешние источники. Если 80% трафика с одного источника —
              это риск. Диверсифицируй.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
            ...
            <p className="text-muted">
              Возраст, пол, география. Это важно для переговоров с
              рекламодателями — они платят за нужную им аудиторию. Если твоя
              аудитория не совпадает с тем что ты думал — пересмотри
              контент-стратегию.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link
              href="/blog/kak-sdelat-thumbnail-abtest"
              className="flex items-center gap-2 text-sm text-muted hover:text-white transition-colors"
            >
              <span>🔬 A/B тест обложек</span>
              <span className="text-accent">→</span>
            </Link>
            <Link
