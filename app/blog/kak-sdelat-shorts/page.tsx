...
export const metadata: Metadata = {
  ...
  description:
    "Как нарезать горизонтальное видео для YouTube Shorts и TikTok: обрезка до 9:16, субтитры, монтаж. Бесплатные инструменты.",
  keywords: ["как сделать shorts из видео", "youtube блогер 2026", "shorts"],
    ...
    <div className="min-h-screen bg-bg">
      ...
      <article className="max-w-2xl mx-auto px-6 py-12">
        <div className="flex items-center gap-2 text-muted text-lg mb-4">
          ...
          <span>·</span>
          <time dateTime="2026-04-01">1 апреля 2026 г.</time>
        </div>

        <h1 className="font-heading text-3xl font-black leading-tight mb-4">
          Как сделать Shorts из обычного видео — пошаговая инструкция
        </h1>
        <p className="text-muted leading-relaxed mb-8">
          Shorts из длинных видео — это бесплатный контент. Уже снятое видео
          даёт дополнительный охват без лишних съёмок.
        </p>

        <div className="p-4 bg-accent/8 border border-accent/20 rounded-xl mb-8 flex items-center justify-between gap-4">
          <div>
            <div className="font-bold text-sm mb-0.5">
              Обрежь своё видео до формата 9:16 прямо сейчас
            </div>
        ...
        <div className="text-sm leading-relaxed space-y-6">
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Какие моменты выбирать для Shorts
            </h2>
            <p className="text-muted">
              Лучшие кандидаты: самый ценный совет из видео, смешной или
              неожиданный момент, шокирующий факт, крутая трансформация, спорное
              утверждение. Момент должен работать без контекста — зрители Shorts
              не смотрели твоё длинное видео.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Обрезка до формата 9:16
            </h2>
            <p className="text-muted">
              Горизонтальное видео нужно обрезать до вертикального. Главное
              правило: лицо говорящего должно быть в верхней трети кадра. Нижняя
              треть — для субтитров. Используй инструмент кропа БлогерКит прямо
              в браузере.
            </p>
          </div>
          <div>
            ...
            <p className="text-muted">
              60% смотрят Shorts без звука. Субтитры увеличивают досмотр на 40%.
              Добавляй их через CapCut (бесплатно, авторасстановка) или через
              YouTube Studio автоматически.
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
              Добавь крючок в начало
            </h2>
            <p className="text-muted">
              Вырезанный момент часто начинается "из середины". Добавь 2-3
              секунды в начало с текстом на экране: о чём это видео. Например:
              "Почему 90% блогеров не зарабатывают — объясню за 30 секунд".
            </p>
          </div>
          <div>
            <h2 className="font-heading text-xl font-bold mt-8 mb-3">
            ...
            <p className="text-muted">
              Загружай вертикальное видео до 60 секунд с хэштегом #Shorts.
              Публикуй Shorts в другое время чем длинные видео — они привлекают
              разную аудиторию. Норма: 3-5 Shorts в неделю.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <span>📱 Как набрать просмотры на Shorts</span>
